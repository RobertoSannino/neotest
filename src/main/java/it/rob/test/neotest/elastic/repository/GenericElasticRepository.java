package it.rob.test.neotest.elastic.repository;

import it.rob.test.neotest.api.v2.QueryContraint;
...
public class GenericElasticRepository {
    ...
    public List<String> getIdsFor(String index, String label, List<QueryContraint> contraints) {
        List<String> ids = new ArrayList<>();

        for (QueryContraint qc : contraints) {
